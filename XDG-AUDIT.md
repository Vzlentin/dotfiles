...
| `~/.zcompdump*` | `$XDG_CACHE_HOME/zsh/zcompdump` | `compinit -d` |
| `~/.gitconfig` | `$XDG_CONFIG_HOME/git/config` | Native Git lookup |
...
| `~/.vimrc` | `$XDG_CONFIG_HOME/vim/vimrc` | Native Vim lookup |
